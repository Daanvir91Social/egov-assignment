...
public class ServiceDAO {
    ...
    public List<Service> findByCriteria(ServiceCriteria serviceCriteria, Pagination pagination) {
        ...
        if(serviceCriteria.getClientId() != null) queryBuider.append("s.client_id = '"+serviceCriteria.getClientId()+"' AND ");
        if(serviceCriteria.getTenantId() != null) queryBuider.append("s.tenant_id = '"+serviceCriteria.getTenantId()+"' AND ");
        if(serviceCriteria.getAccountId() != null) queryBuider.append("s.account_id = '"+serviceCriteria.getClientId()+"' AND ");
        ...
        if(serviceCriteria.getServiceDefIds() != null && serviceCriteria.getServiceDefIds().size() > 0) {
            queryBuider.append(" s.service_definition_id in ('"+ String.join("','", serviceCriteria.getServiceDefIds()) +"') AND ");
        }
        if(serviceCriteria.getReferenceIds() != null && serviceCriteria.getReferenceIds().size() > 0) {
            queryBuider.append(" s.reference_id in ('"+ String.join("','", serviceCriteria.getReferenceIds()) +"') AND ");
        }
